...
<div class="row" id="filter">
    <div class="col-md-2">
        <form action="<?php echo base_url(); ?>template/filter_sample_data" method="post" id="filter_form">
            <div class="row">
                <div class="col-md-12">
                    <select class="btn js-example-basic-single" style="width:220px;background-color: #C5EFF7;" name="partner">
                        <option value="0" disabled="true" selected="true"><?= lang('label.select_sample_type'); ?></option>
                        <option value="NA"><?= lang('label.all_sample_type'); ?></option>
