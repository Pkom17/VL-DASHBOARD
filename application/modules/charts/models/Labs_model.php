...
//						$ul .= "<td>" . number_format((int) $value['confirm2vl']) . "</td>";
    ...
    function lab_testing_trends($year = NULL) {
        ...
        if ($result) {
            ...
            echo "<pre>";
            print_r(lang('label.no_testing_data_found'));
            echo "</pre>";
            die();
        }
    ...
    function lab_rejection_trends($year = NULL) {
        ...
        if ($result) {
            ...
            echo "<pre>";
            print_r(lang('label.no_rejection_data_found'));
            echo "</pre>";
            die();
        }
    ...
    function labs_turnaround($year = NULL, $month = NULL, $to_year = null, $to_month = null) {
        ...
        if ($result) {
            ...
            echo "<pre>";
            print_r(lang('label.no_tat_data_found'));
            echo "</pre>";
            die();
        }
        ...
        foreach ($months as $m) {
            foreach ($result as $value) {
                ...
                if ((int) $m == (int) $month) {
                    ...
                    $data['suppression_trends'][$i]['data'][] = round(@(($value['suppressed'] * 100) / $tests), 1, PHP_ROUND_HALF_UP);
                    ...
                    $data['rejected_trends'][$i]['data'][] = round(@(($value['rejected'] * 100) / $value['received']), 1, PHP_ROUND_HALF_UP);
